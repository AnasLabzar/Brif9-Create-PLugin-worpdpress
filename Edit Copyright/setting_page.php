...
<div class="wrap">
  ...
  <div class="metabox-holder">
    <div class="postbox">
      <h3><strong>Enter Copyright text and click on save button.</strong></h3>
      <form method="post" action="">
        <table class="form-table">
          <tr>
            <th scope="row" style="position:relative; left: 15px;">Copyright Text</th>
            <td><input type="text" name="footertextname" value="<?php echo get_option('footer_text');?>"
